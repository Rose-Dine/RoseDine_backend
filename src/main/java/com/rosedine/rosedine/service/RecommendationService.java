...
public class RecommendationService {
    ...
    @Autowired
    public RecommendationService(CachedMenuItemService menuItemService, UserService userService) {
    ...
    public List<Map<String, Object>> getRecommendations(int userId, String mealType, String date) {
        ...
        int totalFats = recommendations.stream().mapToInt(MenuItemDTO::getFats).sum();
        ...
        return recommendations.stream()
                .map(item -> {
                    ...
                    recommendation.put("fatsMatch", calculateMacroMatch(item.getFats(), userPreferences.getFats()));
