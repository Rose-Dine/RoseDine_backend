...
public class NotificationService {
    ...
    private NotificationState state = new EnabledState();
    ...
    public void sendNotifications(int userId) {
        List<NotificationFood> foods = getNotificationFoods(userId);
        state.sendNotification(foods);
    }
